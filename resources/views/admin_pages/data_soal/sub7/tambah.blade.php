            ...
            <div class="row">
                <div class="col">
                    <div class="card shadow mb-4">
                        ...
                        <!-- Card Body -->
                        <div class="card-body">
                            <h4>Tambah Soal Untuk Subtes 7</h4>
                            <form action="{{route('tambah.sub7')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="t7_jawaban">Jawaban Soal</label>
                                    <input id="t7_jawaban" class="form-control" type="text" name="jwb" required>
                                </div>
