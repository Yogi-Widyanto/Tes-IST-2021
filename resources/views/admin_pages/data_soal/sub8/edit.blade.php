                ...
                <div class="col">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('update.sub8')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @php
                                    $opsi='for-subtes/image_tes/'.$item->mainSoal_t8;
                                    $soal='for-subtes/image_tes/'.$item->keterangan_t8;
                                @endphp
                                <input type="hidden" name="id" value="{{ $item->idsoal_t8 }}"> <br/>
                                <input type="hidden" name="opsiSoalSave" value="{{ $item->mainSoal_t8 }}"> <br/>
                                <input type="hidden" name="soalSave" value="{{ $item->keterangan_t8 }}"> <br/>
                                <div class="form-group">
                                    <label for="opsi">Pilihan Opsi</label>
                                    <input id="opsi" class="form-control" type="text" name="opsi" value="{{$item->mainSoal_t8}}" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="soal" class="form-control" type="text" name="soal" value="{{$item->keterangan_t8}}" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="t6_jawaban" class="form-control" type="text" name="lihatjwb" value="{{$item->t8_jawaban}}" readonly>
                                </div>
