                ...
                <div class="col">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('update.sub2')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{ $item->idsoal_t2 }}"> <br/>
                                <div class="form-group">
                                    <label for="soal">Soal</label>
                                    <input id="soal" class="form-control" type="text" name="soal" value="{{$item->keterangan_t2}}">
                                </div>

                                <div class="form-group">
                                    <label for="opsia">Opsi A</label>
                                    <input id="opsia" class="form-control" type="text" name="opsia" value="{{$item->t2_opsia}}">
                                </div>

                                <div class="form-group">
                                    <label for="opsib">Opsi B</label>
                                    <input id="opsib" class="form-control" type="text" name="opsib" value="{{$item->t2_opsib}}">
                                </div>

                                <div class="form-group">
                                    <label for="opsic">Opsi C</label>
                                    <input id="opsic" class="form-control" type="text" name="opsic" value="{{$item->t2_opsic}}">
                                </div>

                                <div class="form-group">
                                    <label for="opsid">Opsi D</label>
                                    <input id="opsid" class="form-control" type="text" name="opsid" value="{{$item->t2_opsid}}">
                                </div>

                                <div class="form-group">
                                    <label for="opsie">Opsi E</label>
                                    <input id="opsie" class="form-control" type="text" name="opsie" value="{{$item->t2_opsie}}">
                                </div>

                                <div class="form-group">
                                    <label for="t2_jawaban">Jawaban Soal</label>
                                    <input id="t2_jawaban" class="form-control" type="text" name="jwb" value="{{$item->t2_jawaban}}">
                                </div>
