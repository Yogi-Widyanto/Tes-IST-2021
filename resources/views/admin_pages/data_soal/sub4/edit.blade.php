                ...
                <div class="col">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('update.sub4')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{ $item->idsoal_t4 }}"> <br/>
                                <div class="form-group">
                                    <label for="soal">Soal</label>
                                    <input id="soal" class="form-control" type="text" name="soal" value="{{$item->keterangan_t4}}">
                                </div>

                                <div class="form-group">
                                    <label for="t4_jawaban">Jawaban Soal</label>
                                    <input id="t4_jawaban" class="form-control" type="text" name="jwb" value="{{$item->t4_jawaban}}">
                                </div>
