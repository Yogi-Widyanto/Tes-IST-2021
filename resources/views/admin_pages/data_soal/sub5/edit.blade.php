                ...
                <div class="col">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('update.sub5')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{ $item->idsoal_t5 }}"> <br/>
                                <div class="form-group">
                                    <label for="soal">Soal</label>
                                    <input id="soal" class="form-control" type="text" name="soal" value="{{$item->keterangan_t5}}">
                                </div>

                                <div class="form-group">
                                    <label for="t5_jawaban">Jawaban Soal</label>
                                    <input id="t5_jawaban" class="form-control" type="text" name="jwb" value="{{$item->t5_jawaban}}">
                                </div>
