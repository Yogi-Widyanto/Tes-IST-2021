                ...
                <div class="col">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('update.sub6')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{ $item->idsoal_t6 }}"> <br/>
                                <div class="form-group">
                                    <label for="soal">Soal</label>
                                    <input id="soal" class="form-control" type="text" name="soal" value="{{$item->keterangan_t6}}">
                                </div>

                                <div class="form-group">
                                    <label for="t6_jawaban">Jawaban Soal</label>
                                    <input id="t6_jawaban" class="form-control" type="text" name="jwb" value="{{$item->t6_jawaban}}">
                                </div>
