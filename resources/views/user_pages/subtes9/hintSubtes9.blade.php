                    ...
                    <div class="col">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Petunjuk Dalam Mengerjakan Soal Tes Menghafal Cepat</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <!-- </div> -->
                                <div>
                                    <a id="hps" class='badge badge-primary' href="{{ route('hafalan.subtes-9')}}">Mulai Mengerjakan</a>
                                </div>
                            </div>
                        </div>
                    </div>
