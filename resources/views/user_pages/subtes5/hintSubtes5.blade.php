                    ...
                    <div class="col">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Petunjuk Dalam Mengerjakan Soal Tes Aritmatika</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <!-- </div> -->
                                <div>
                                    <a id="hps" class='badge badge-primary' href="{{ route('subtes-5')}}">Mulai Mengerjakan</a>
                                </div>
                            </div>
                        </div>
                    </div>
